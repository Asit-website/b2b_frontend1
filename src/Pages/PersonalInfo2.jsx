...
import photo from "../image/manProfile.png"
    ...
    return (
        <div className="persInfoWrap">
            ...
            <div className="btnWrap">
                    ...
                    <button className="uploadNew"><span>Upload new picture</span>  </button>

                    <button className="deleteProfile"><span>Delete</span></button>
            </div>
